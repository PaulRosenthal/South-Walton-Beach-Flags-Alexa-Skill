 ...
 * The flag status is retrieved from the https://github.com/PaulRosenthal/South-Walton-Beach-Flags-Alexa-Skill
...
const LaunchRequestHandler = {
    ...
    async handle(handlerInput) {
        ...
        try {
            var flag_status = await axios.get("https://raw.githubusercontent.com/PaulRosenthal/South-Walton-Beach-Flags-Alexa-Skill/main/current-flag-status.txt").then(function(response) {
